...
export const RoleSelector = ({ role, onRoleChange, error }: RoleSelectorProps) => {
  return (
      ...
      <div className="flex flex-col gap-[6px]">
        ...
        <div className="relative">
          <input
            ...
            className={ `bg-white h-[43.98px] px-[12px] rounded-[8px] w-full text-[14px] leading-[21px] placeholder:text-[#6b7280] outline-none border border-solid focus:border-[#4f46e5] transition-colors ${error ? 'border-[#ef4444]' : 'border-[#d1d5db]'
              }` }
            value={ role }
