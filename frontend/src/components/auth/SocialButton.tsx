...
export const SocialButton = ({ icon, label, onClick }: SocialButtonProps) => {
  return (
    <Button
      variant="outline"
      onClick={ onClick }
      className="bg-white border-[#d1d5db] flex gap-[5.98px] items-center justify-center px-[17.25px] py-[13.25px] h-auto rounded-[8px] w-full hover:bg-gray-50 transition-colors shadow-none cursor-pointer"
    >
